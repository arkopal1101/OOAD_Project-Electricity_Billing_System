        ...
        if(ae.getSource() == b1){
            ...
            try{
                ...
                if(user.equals("Admin")){
                    str = "insert into login ( meter, username, name, password, user) values('"+meter+"','"+username+"', '"+name+"', '"+password+"', '"+user+"')";
                }else{
//                      str = "insert into login ( username, name, password, user, meter) values('"+username+"', '"+name+"', '"+password+"', '"+user+"','"+meter+"')";

                    str = "update login set username = '"+username+"', name = '"+name+"', password = '"+password+"', user = '"+user+"' where meter = '"+meter+"'";
                }
